    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        ...
        <p className="max-w-2xl mx-auto text-[15px] sm:text-[17px] text-eq-t2 leading-relaxed mb-9">
          ...
          Ask the Copilot to generate templates, explain your Sharpe, and debug
...
function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      desc:
        'Ticker → Log Returns → EMA → Threshold → Backtest. Edit params live. The Copilot suggests the next block.',
    },
    {
      icon: Play,
